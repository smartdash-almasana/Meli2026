...
type MultiField = 'channels' | 'current_tools' | 'manual_tasks' | 'problems' | 'priorities' | 'growth_difficulties' | 'margin_components' | 'post_sale_channels'
...
const emptyDraft: DiscoveryDraft = {
  ...
  stock_owner: '', stock_sync: '', stockout_frequency: '', supplier_lead_time: '', supplier_count: '', uses_full: '', ads_usage: '', ads_manager: '', ads_budget_method: '', ads_profitability: '', post_sale_channels: [], recurring_postsale_issue: '', open_problem: '', missing_data: '',
